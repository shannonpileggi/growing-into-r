...
meta() %>%
  ...
  meta_social(
    title = "Growing into the R community",
    description = paste(
      "An R-Ladies Miami meet-up about starting as a consumer by leveraging the R community for a job interview, eventually leading to a contributor."
    ),
    url = "https://shannonpileggi.github.io/growing-into-r/#1",
    image = "https://github.com/shannonpileggi/growing-into-r/blob/main/img/cover.PNG",
    image_alt = paste(
